...
- The default view (active + rated) and the "include all" toggle were collapsed from an earlier two-chart design once it became clear the all-vs-active split barely mattered — inactive players are only ~7% of registrations, dwarfed by the ~64% who were never rated at all
